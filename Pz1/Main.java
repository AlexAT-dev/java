...
public class Main {
    public static void main(String[] args) {
        ...
        do
        {
            System.out.println("Практична 1. Оберіть завдання:");
            System.out.println("1 — Завдання 1:\n\tномер мінімального за модулем елемента масиву;\n\tСума елементів масиву, розташованих між першим й останнім додатними елементами\n");
            System.out.println("2 — Завдання 2:\n\tОбчислення суми елементів масиву з непарними індексами.\n ");
